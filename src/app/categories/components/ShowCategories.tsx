            ...
            <table className="w-full">
                <thead>
                    <tr className="bg-surface-2 border-b border-border">
                        <th className="text-left px-6 py-4 text-muted font-semibold text-sm">Nombre</th>
                        <th className="text-left px-6 py-4 text-muted font-semibold text-sm">Descripción</th>
