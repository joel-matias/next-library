...
export default function BookForm({ categories, initialBook }: Props) {
    ...
    return (
        <form onSubmit={handleSubmit} className="bg-card rounded-xl border border-border p-6 max-w-lg">
            ...
            <div className="mb-5">
                <label htmlFor="title" className="block text-muted text-sm font-medium mb-2">
            ...
            <div className="mb-5">
                <label htmlFor="author" className="block text-muted text-sm font-medium mb-2">
            ...
            <div className="mb-5">
                <label htmlFor="categoryId" className="block text-muted text-sm font-medium mb-2">
            ...
            <div className="grid grid-cols-2 gap-4 mb-5">
                <div>
                    <label htmlFor="year" className="block text-muted text-sm font-medium mb-2">
                        Año de publicación
                    </label>
                    <input
                        id="year"
                ...
                <div>
                    <label htmlFor="isbn" className="block text-muted text-sm font-medium mb-2">
                        ISBN
                    </label>
                    <input
                        id="isbn"
                        ...
                        className="w-full bg-input-bg border border-input-border text-foreground rounded-lg px-4 py-2.5 focus:outline-none focus:border-input-focus transition-colors font-mono"
